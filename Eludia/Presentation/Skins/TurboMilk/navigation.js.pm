...
function idx_tables (__scrollable_table_row) {
	...
	$(scrollable_table_ids).each (function (n) {
		...
		$(trs).each (function (i) {
			...
			scrollable_rows.push (this);
			tr2sr [this.uniqueID] = i;
			
			$('td', this).each (function (j) {
				
				td2sc [this.uniqueID] = j;
...
function td_on_click () {
	...
	var new_scrollable_table_row = tr2sr [td.parentElement.uniqueID];
	var new_scrollable_table_row_cell = td2sc [td.uniqueID];
