...
//				iLeftWidth = iWidth;
	...
	"_fnGridLayout": function ()
	{
		...
		if ( this.s.iLeftColumns > 0 )
		{
			...
			oGrid.left.wrapper.style.height = iBodyHeight+"px";
...
var browser_is_msie = /Trident\/\d\./i.test(navigator.userAgent);
$.browser.msie = $.browser.msie || browser_is_msie;
