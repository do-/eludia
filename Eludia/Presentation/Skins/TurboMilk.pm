...
//			}
			...
			if (code_alt_ctrl (116, 0, 0)) {
				...
				if (is_dirty) {
					...
					if (!confirm ('¬нимание! ¬ы изменили содержимое некоторых полей ввода. ѕерезагрузка страницы приведЄт к утере этой информации. ѕродолжить?')) return blockEvent ();
