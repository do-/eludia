...
sub do_add_DEFAULT { # —ли€ние дубликатов
...
#	get_ids ($_REQUEST {type}) > 0 or return '¬ы не выделили ни одной строки';
#	return undef;
#}
...
sub do_update_columns_DEFAULT { # переставили колонки, помен€ли сортировку
